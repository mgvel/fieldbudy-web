...
const PendindRejectedReview = () => {
  ...
  const getproject = async () => {
    try {
      const { data } = await axiosInstance.get(
        `/project/widgets/my_pending_rejected_review_comments_implementation`
      );
  ...
  return (
    <div className="w-[75vw] mx-auto">
      ...
      />
      <div className="flex justify-between tems-center mb-2">
        <h2 className="text-xl font-bold ">My Pending Rejected Review Comments Implementation</h2>
...
export default PendindRejectedReview;