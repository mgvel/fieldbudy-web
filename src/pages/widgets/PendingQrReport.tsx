  ...
  const getproject = async () => {
    try {
      const { data } = await axiosInstance.get(
        `/project/widgets/my_pending_report_review_as_qr`
      );
  ...
  return (
    <div className="w-[75vw] mx-auto">
      ...
      <div className="flex justify-between items-center mb-2">
        <h2 className="text-xl font-bold">My Pending Reports Review as QR</h2>
...
export default PendingQrReport;