...
const MyPendingFbPendingReview = () => {
  ...
  return (
    <div className="w-[75vw] mx-auto">
      ...
      <div className="flex justify-between items-center mb-2">
        <h2 className="text-xl font-bold ">My Pending Fb Pending Review</h2>
...
export default MyPendingFbPendingReview;