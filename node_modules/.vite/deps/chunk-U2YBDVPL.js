...
true ? IconButton.propTypes = {
  ...
  children: chainPropTypes(import_prop_types27.default.node, (props) => {
    const found = React32.Children.toArray(props.children).some((child) => React32.isValidElement(child) && child.props.onClick);
    if (found) {
...
var Chip = React42.forwardRef(function Chip2(inProps, ref) {
  ...
  return (0, import_jsx_runtime36.jsxs)(RootSlot, {
    as: component,
    ...rootProps,
    children: [avatar || icon, (0, import_jsx_runtime36.jsx)(LabelSlot, {
      ...labelProps,
      children: label
    }), deleteIcon]
  });
...
//# sourceMappingURL=chunk-U2YBDVPL.js.map
