import {
  ...
  useViews,
  validateDate
} from "./chunk-NN7O75MS.js";
import {
  Fade_default,
  IconButton_default,
  Typography_default,
  useSlotProps_default
} from "./chunk-U2YBDVPL.js";
import {
  useThemeProps
} from "./chunk-DD4FFEVK.js";
import {
  ButtonBase_default,
  CSSTransition_default,
  TransitionGroup_default
} from "./chunk-NYFFKSTD.js";
import {
  useControlled,
  useEventCallback_default,
  useForkRef
} from "./chunk-IHQBZMK2.js";
import {
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React2.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React7.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React7.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
  ...
  return (0, import_jsx_runtime4.jsxs)(PickersCalendarDayRoot, {
    ...
    children: [(0, import_jsx_runtime4.jsxs)(PickersCalendarDayHeader, {
      ...
      }), getWeekdays(adapter, now).map((weekday, i) => (0, import_jsx_runtime4.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
...
var MonthCalendar = React9.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React9.useMemo(() => adapter.getMonth(now), [adapter, now]);
  ...
  const [focusedMonth, setFocusedMonth] = React9.useState(() => selectedMonth || adapter.getMonth(referenceDate));
...
var YearCalendar = React11.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React11.useMemo(() => adapter.getYear(now), [adapter, now]);
  ...
  const [focusedYear, setFocusedYear] = React11.useState(() => selectedYear || adapter.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
...
//# sourceMappingURL=chunk-BAT4UXLQ.js.map
